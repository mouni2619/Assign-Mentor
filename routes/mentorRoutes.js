...
// Root endpoint to provide an overview of the project
...
// API endpoint to assign a mentor to a student
...
// API endpoint to retrieve all students assigned to a mentor
 ...
 // API endpoint to retrieve the previous mentor of a student       
router.get('/students/:studentId/previous-mentor', async (req, res) => {
  try {
    ...
    // Include student's name in the response
    const responseData = {
...
// API endpoint to retrieve all Mentors
